...
func get_canvas_layer():
	var path = "../../../../TelopCoordinator/MessageWindow_" + str(self.name)
	return self.get_node(path)


func get_text_block():
	var path = "../../../../TelopCoordinator/MessageWindow_" + str(self.name) + "/TextBlock"
	return self.get_node(path)


func get_choice_cursor():
	var path = "../../../../TelopCoordinator/MessageWindow_" + str(self.name) + "/TextBlock/ChoiceCursor"
	return self.get_node(path)
