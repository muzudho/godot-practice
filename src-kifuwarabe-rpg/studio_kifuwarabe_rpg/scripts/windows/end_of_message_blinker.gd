...
# 状態機械
var statemachine_of_end_of_message_blinker = load("res://studio_kifuwarabe_rpg/scripts/statemachines/end_of_message_blinker.gd").new()
var statemachine_of_blinker = load("res://studio_kifuwarabe_rpg/scripts/statemachines/blinker.gd").new()
