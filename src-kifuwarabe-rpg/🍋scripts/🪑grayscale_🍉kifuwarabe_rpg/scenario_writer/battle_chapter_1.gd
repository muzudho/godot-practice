...
var scenario_document = {
	...
	"§エンカウント・トランジション":[
		...
		!
		bg:				📂🗻戦闘開始トランジション/🗻２コマ
		bg:				📂🗻戦闘開始トランジション/🗻１コマ, hide
		sleep:			0.15
		""",
		"""\
		!
		bg:				📂🗻戦闘開始トランジション/🗻３コマ
		bg:				📂🗻戦闘開始トランジション/🗻２コマ, hide
		sleep:			0.15
		""",
		"""\
		!
		bg:				📂🗻戦闘開始トランジション/🗻４コマ
		bg:				📂🗻戦闘開始トランジション/🗻３コマ, hide
		bg:				{{arg_bg_out}}, hide
		bg:				{{arg_bg_in}}
		sleep:			0.15
		""",
		...
		bg:				📂🗻戦闘開始トランジション/🗻８コマ
		bg:				📂🗻戦闘開始トランジション/🗻４コマ, hide
		sleep:			0.10
		""",
		"""\
		!
		bg:				📂🗻戦闘開始トランジション/🗻９コマ
		bg:				📂🗻戦闘開始トランジション/🗻８コマ, hide
		sleep:			0.10
		""",
		"""\
		!
		bg:				📂🗻戦闘開始トランジション/🗻１０コマ
		bg:				📂🗻戦闘開始トランジション/🗻９コマ, hide
		sleep:			0.10
		""",
		# 少し長めのフレーム
		"""\
		!
		bg:				📂🗻戦闘開始トランジション/🗻１１コマ
		bg:				📂🗻戦闘開始トランジション/🗻１０コマ, hide
		sleep:			0.20
		""",
		"""\
		!
		bg:				🗻戦闘シーン
		bg:				📂🗻戦闘開始トランジション/🗻１１コマ, hide
		sleep:			0.10
		""",
		"""\
		!
